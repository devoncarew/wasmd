...
class Module {
  ...
  f64 _func4(f64 arg0, f64 arg1, f64 arg2, f64 arg3) {
    final frame = Frame(memory);
    frame.push(arg0);
    frame.push(arg1);
    frame.push(arg3);
  ...
  void _func6(i32 arg0, i32 arg1, i32 arg2) {
    final frame = Frame(memory);
    frame.push(arg0);
    frame.i32_load(2, 4);
    frame.push(arg1);
  ...
  void _func10() {
    ...
    if_label_0:
    if (frame.pop() != 0) {
      frame.i32_const(1056);
      frame.i32_const(1104);
      frame.i32_const(19);
      frame.i32_const(57);
      {
        var t3 = frame.pop();
