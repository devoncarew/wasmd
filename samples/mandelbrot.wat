(module
 ...
 (global $mandelbrot/width (mut i32) (i32.const 1200))
 (global $mandelbrot/height (mut i32) (i32.const 800))
 (export "width" (global $mandelbrot/width))
 (export "height" (global $mandelbrot/height))
 ...
 (func $bufferSize (result i32)
  i32.const 4
  global.get $mandelbrot/height
  global.get $mandelbrot/width
  i32.mul
  i32.mul
 )
