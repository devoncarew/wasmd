;; INFO asc module.ts --textFile module.wat --outFile module.wasm --bindings raw -O3z --converge --debug --noAssert --runtime stub
(module
 ...
 (export "iterateEquation" (func $module/iterateEquation))
 ...
 (func $module/iterateEquation (type $f64_f64_i32_=>_i32) (param $0 f64) (param $1 f64) (param $2 i32) (result i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 i32)
  (local $6 f64)
