...
class Sha3Module implements Module {
  ...
  void _func0(i32 arg0, i32 arg1, i32 arg2) {
    var t0 = vm.i64_store(3, 0, arg0, 0);
    var t1 = vm.i64_store(3, 8, arg0, 0);
    var t2 = vm.i64_store(3, 16, arg0, 0);
    var t3 = vm.i64_store(3, 32, arg0, 0);
    var t4 = vm.i64_store(3, 40, arg0, 0);
    var t5 = vm.i64_store(3, 48, arg0, 0);
    var t6 = vm.i64_store(3, 56, arg0, 0);
    var t7 = vm.i64_store(3, 64, arg0, 0);
    var t8 = vm.i64_store(3, 72, arg0, 0);
    var t9 = vm.i64_store(3, 80, arg0, 0);
    var t10 = vm.i64_store(3, 88, arg0, 0);
    var t11 = vm.i64_store(3, 964, arg0, 0);
    var t12 = vm.i64_store(3, 104, arg0, 0);
    var t13 = vm.i64_store(3, 112, arg0, 0);
    var t14 = vm.i64_store(3, 120, arg0, 0);
    var t15 = vm.i64_store(3, 128, arg0, 0);
    var t16 = vm.i64_store(3, 136, arg0, 0);
    var t17 = vm.i64_store(3, 144, arg0, 0);
    var t18 = vm.i64_store(3, 152, arg0, 0);
    var t19 = vm.i64_store(3, 160, arg0, 0);
    var t20 = vm.i64_store(3, 168, arg0, 0);
    var t21 = vm.i64_store(3, 176, arg0, 0);
    var t22 = vm.i64_store(3, 184, arg0, 0);
    var t23 = vm.i64_store(3, 192, arg0, 0);
    var t24 = vm.i64_store(3, 200, arg0, 0);
    var t25 = vm.i32_store(2, 0, arg0, arg1);
  }
    ...
    block_label_0:
    {
      block_label_1:
      {
        block_label_2:
        {
          ...
          var t0 = vm.i64_store8(0, 0, arg1, 31);
          break block_label_0;
        }
        var t1 = vm.i64_store8(0, 0, arg1, 1);
        break block_label_0;
      }
      var t2 = vm.i64_store8(0, 0, arg1, 6);
      break block_label_0;
    }
    block_label_0:
    {
      loop_label_1:
      for (;;) {
        var t3 = vm.i32_add(arg2, 1);
        var t4 = vm.i32_mul(t3, 8);
        var t5 = vm.i32_rem_u(t4, arg0);
        var t6 = vm.i32_eq(t5, 0);
        if (t6 != 0) break block_label_0;
        var t7 = vm.i32_add(arg2, 1);
        arg2 = t7;
        var t8 = vm.i32_add(arg1, 1);
        arg1 = t8;
        var t9 = vm.i64_store8(0, 0, arg1, 0);
        continue loop_label_1;
        break;
      }
    }
    var t10 = vm.i64_load(3, 0, arg1);
    var t11 = vm.i64_or(t10, 128);
    var t12 = vm.i64_store(3, 0, arg1, t11);
    var t13 = vm.i32_add(arg2, 1);
    arg2 = t13;
    var t14 = vm.i32_sub(arg2, local0);
    return t14;
  }
    ...
    block_label_0:
    {
      ...
      for (;;) {
        ...
        block_label_2:
        {
          ...
          var t16 = vm.i64_store(3, 8, t11, t15);
          var t17 = vm.i32_add(arg1, 8);
          arg1 = t17;
          var t18 = vm.i32_add(local0, 8);
          local0 = t18;
          continue loop_label_1;
        }
        var t19 = vm.i32_add(arg0, local0);
        var t20 = vm.i32_add(arg0, local0);
        var t21 = vm.i64_load8_u(0, 8, t20);
        var t22 = vm.i64_load8_u(0, 0, arg1);
        var t23 = vm.i64_xor(t21, t22);
        var t24 = vm.i64_store8(0, 8, t19, t23);
        var t25 = vm.i32_add(arg1, 1);
        arg1 = t25;
        var t26 = vm.i32_add(local0, 1);
        local0 = t26;
        continue loop_label_1;
        break;
      }
    }
    var t27 = vm.i32_load(2, 4, arg0);
    var t28 = vm.i32_div_u(t27, 8);
    var t29 = vm.i32_mul(t28, 8);
    var t30 = vm.i32_sub(arg1, local2);
    var t31 = vm.i32_add(t29, t30);
    var t32 = vm.i32_store(2, 4, arg0, t31);
    var t33 = vm.i32_sub(arg1, local2);
    var t34 = vm.i32_rem_u(t33, 8);
    return t34;
  }
    ...
    block_label_0:
    {
      ...
      for (;;) {
        ...
        block_label_2:
        {
          ...
          var t4 = vm.i64_store(3, 0, arg1, t3);
          var t5 = vm.i32_add(local2, 8);
          local2 = t5;
          var t6 = vm.i32_ge_u(local2, local3);
          if (t6 != 0) break block_label_2;
          var t7 = vm.i64_load(3, 8, local0);
          var t8 = vm.i64_store(3, 8, arg1, t7);
          var t9 = vm.i32_add(local2, 8);
          local2 = t9;
          var t10 = vm.i32_ge_u(local2, local3);
          if (t10 != 0) break block_label_2;
          var t11 = vm.i64_load(3, 16, local0);
          var t12 = vm.i64_store(3, 16, arg1, t11);
          var t13 = vm.i32_add(local2, 8);
          local2 = t13;
          var t14 = vm.i32_ge_u(local2, local3);
          if (t14 != 0) break block_label_2;
          var t15 = vm.i64_load(3, 24, local0);
          var t16 = vm.i64_store(3, 24, arg1, t15);
          var t17 = vm.i32_add(local2, 8);
          local2 = t17;
          var t18 = vm.i32_ge_u(local2, local3);
          if (t18 != 0) break block_label_2;
          var t19 = vm.i64_load(3, 32, local0);
          var t20 = vm.i64_store(3, 32, arg1, t19);
          var t21 = vm.i32_add(local2, 8);
          local2 = t21;
          var t22 = vm.i32_ge_u(local2, local3);
          if (t22 != 0) break block_label_2;
          var t23 = vm.i64_load(3, 40, local0);
          var t24 = vm.i64_store(3, 40, arg1, t23);
          var t25 = vm.i32_add(local2, 8);
          local2 = t25;
          var t26 = vm.i32_ge_u(local2, local3);
          if (t26 != 0) break block_label_2;
          var t27 = vm.i64_load(3, 48, local0);
          var t28 = vm.i64_store(3, 48, arg1, t27);
          var t29 = vm.i32_add(local2, 8);
          local2 = t29;
          var t30 = vm.i32_ge_u(local2, local3);
          if (t30 != 0) break block_label_2;
          var t31 = vm.i64_load(3, 56, local0);
          var t32 = vm.i64_store(3, 56, arg1, t31);
          var t33 = vm.i32_add(local2, 8);
          local2 = t33;
          var t34 = vm.i32_ge_u(local2, local3);
          if (t34 != 0) break block_label_2;
          var t35 = vm.i64_load(3, 64, local0);
          var t36 = vm.i64_store(3, 64, arg1, t35);
          var t37 = vm.i32_add(local2, 8);
          local2 = t37;
          var t38 = vm.i32_ge_u(local2, local3);
          if (t38 != 0) break block_label_2;
          var t39 = vm.i64_load(3, 72, local0);
          var t40 = vm.i64_store(3, 72, arg1, t39);
          var t41 = vm.i32_add(local2, 8);
          local2 = t41;
          var t42 = vm.i32_ge_u(local2, local3);
          if (t42 != 0) break block_label_2;
          var t43 = vm.i64_load(3, 80, local0);
          var t44 = vm.i64_store(3, 80, arg1, t43);
          var t45 = vm.i32_add(local2, 8);
          local2 = t45;
          var t46 = vm.i32_ge_u(local2, local3);
          if (t46 != 0) break block_label_2;
          var t47 = vm.i64_load(3, 88, local0);
          var t48 = vm.i64_store(3, 88, arg1, t47);
          var t49 = vm.i32_add(local2, 8);
          local2 = t49;
          var t50 = vm.i32_ge_u(local2, local3);
          if (t50 != 0) break block_label_2;
          var t51 = vm.i64_load(3, 96, local0);
          var t52 = vm.i64_store(3, 96, arg1, t51);
          var t53 = vm.i32_add(local2, 8);
          local2 = t53;
          var t54 = vm.i32_ge_u(local2, local3);
          if (t54 != 0) break block_label_2;
          var t55 = vm.i64_load(3, 104, local0);
          var t56 = vm.i64_store(3, 104, arg1, t55);
          var t57 = vm.i32_add(local2, 8);
          local2 = t57;
          var t58 = vm.i32_ge_u(local2, local3);
          if (t58 != 0) break block_label_2;
          var t59 = vm.i64_load(3, 112, local0);
          var t60 = vm.i64_store(3, 112, arg1, t59);
          var t61 = vm.i32_add(local2, 8);
          local2 = t61;
          var t62 = vm.i32_ge_u(local2, local3);
          if (t62 != 0) break block_label_2;
          var t63 = vm.i64_load(3, 120, local0);
          var t64 = vm.i64_store(3, 120, arg1, t63);
          var t65 = vm.i32_add(local2, 8);
          local2 = t65;
          var t66 = vm.i32_ge_u(local2, local3);
          if (t66 != 0) break block_label_2;
          var t67 = vm.i64_load(3, 128, local0);
          var t68 = vm.i64_store(3, 128, arg1, t67);
          var t69 = vm.i32_add(local2, 8);
          local2 = t69;
          var t70 = vm.i32_ge_u(local2, local3);
          if (t70 != 0) break block_label_2;
          var t71 = vm.i64_load(3, 136, local0);
          var t72 = vm.i64_store(3, 136, arg1, t71);
          var t73 = vm.i32_add(local2, 8);
          local2 = t73;
          var t74 = vm.i32_ge_u(local2, local3);
          if (t74 != 0) break block_label_2;
          var t75 = vm.i64_load(3, 144, local0);
          var t76 = vm.i64_store(3, 144, arg1, t75);
          var t77 = vm.i32_add(local2, 8);
          local2 = t77;
          var t78 = vm.i32_ge_u(local2, local3);
          if (t78 != 0) break block_label_2;
          var t79 = vm.i64_load(3, 152, local0);
          var t80 = vm.i64_store(3, 152, arg1, t79);
          var t81 = vm.i32_add(local2, 8);
          local2 = t81;
          var t82 = vm.i32_ge_u(local2, local3);
          if (t82 != 0) break block_label_2;
          var t83 = vm.i64_load(3, 160, local0);
          var t84 = vm.i64_store(3, 160, arg1, t83);
          var t85 = vm.i32_add(local2, 8);
          local2 = t85;
          var t86 = vm.i32_ge_u(local2, local3);
          if (t86 != 0) break block_label_2;
          var t87 = vm.i64_load(3, 168, local0);
          var t88 = vm.i64_store(3, 168, arg1, t87);
          var t89 = vm.i32_add(local2, 8);
          local2 = t89;
          var t90 = vm.i32_ge_u(local2, local3);
          if (t90 != 0) break block_label_2;
          var t91 = vm.i64_load(3, 176, local0);
          var t92 = vm.i64_store(3, 176, arg1, t91);
          var t93 = vm.i32_add(local2, 8);
          local2 = t93;
          var t94 = vm.i32_ge_u(local2, local3);
          if (t94 != 0) break block_label_2;
          var t95 = vm.i64_load(3, 184, local0);
          var t96 = vm.i64_store(3, 184, arg1, t95);
          var t97 = vm.i32_add(local2, 8);
          local2 = t97;
          var t98 = vm.i32_ge_u(local2, local3);
          if (t98 != 0) break block_label_2;
          var t99 = vm.i64_load(3, 192, local0);
          var t100 = vm.i64_store(3, 192, arg1, t99);
        }
        var t101 = vm.i32_ge_u(local1, arg2);
        if (t101 != 0) break block_label_0;
        var t102 = vm.i32_add(arg1, local3);
        arg1 = t102;
        var t103 = vm.i32_add(local1, local3);
        local1 = t103;
        _func5(arg0);
        continue loop_label_1;
        break;
  ...
  void _func5(i32 arg0) {
    ...
    globals.global0 = t49;
    var t50 = vm.i64_store(3, 0, local0, globals.global0);
    var t51 = vm.i64_store(3, 8, local0, globals.global2);
    var t52 = vm.i64_store(3, 16, local0, globals.global4);
    var t53 = vm.i64_store(3, 24, local0, globals.global6);
    var t54 = vm.i64_store(3, 32, local0, globals.global8);
    var t55 = vm.i64_store(3, 40, local0, globals.global10);
    var t56 = vm.i64_store(3, 48, local0, globals.global12);
    var t57 = vm.i64_store(3, 56, local0, globals.global14);
    var t58 = vm.i64_store(3, 64, local0, globals.global16);
    var t59 = vm.i64_store(3, 72, local0, globals.global18);
    var t60 = vm.i64_store(3, 80, local0, globals.global20);
    var t61 = vm.i64_store(3, 88, local0, globals.global22);
    var t62 = vm.i64_store(3, 96, local0, globals.global24);
    var t63 = vm.i64_store(3, 104, local0, globals.global26);
    var t64 = vm.i64_store(3, 112, local0, globals.global28);
    var t65 = vm.i64_store(3, 120, local0, globals.global30);
    var t66 = vm.i64_store(3, 128, local0, globals.global32);
    var t67 = vm.i64_store(3, 136, local0, globals.global34);
    var t68 = vm.i64_store(3, 144, local0, globals.global36);
    var t69 = vm.i64_store(3, 152, local0, globals.global38);
    var t70 = vm.i64_store(3, 160, local0, globals.global40);
    var t71 = vm.i64_store(3, 168, local0, globals.global42);
    var t72 = vm.i64_store(3, 176, local0, globals.global44);
    var t73 = vm.i64_store(3, 184, local0, globals.global46);
    var t74 = vm.i64_store(3, 192, local0, globals.global48);
  }
}
