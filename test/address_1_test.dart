...
void main() {
  group('address_1', () {
    ...
    returns('test_32u_good1_0', m.test_32u_good1_0, 0x64636261);
    returns('test_32u_good2_0', m.test_32u_good2_0, 0x64636261);
    returns('test_32u_good3_0', m.test_32u_good3_0, 0x65646362);
    returns('test_32u_good4_0', m.test_32u_good4_0, 0x66656463);
    returns('test_32u_good5_0', m.test_32u_good5_0, 122);
    returns('test_32s_good1_0', m.test_32s_good1_0, 0x64636261);
    returns('test_32s_good2_0', m.test_32s_good2_0, 0x64636261);
    returns('test_32s_good3_0', m.test_32s_good3_0, 0x65646362);
    returns('test_32s_good4_0', m.test_32s_good4_0, 0x66656463);
    returns('test_32s_good5_0', m.test_32s_good5_0, 122);
    returns('test_64_good1_0', m.test_64_good1_0, 0x6867666564636261);
    returns('test_64_good2_0', m.test_64_good2_0, 0x6867666564636261);
    returns('test_64_good3_0', m.test_64_good3_0, 0x6968676665646362);
    returns('test_64_good4_0', m.test_64_good4_0, 0x6a69686766656463);
    returns('test_64_good5_0', m.test_64_good5_0, 122);
    ...
    returns('test_32u_good1_1', m.test_32u_good1_1, 0);
    returns('test_32u_good2_1', m.test_32u_good2_1, 0);
    returns('test_32u_good3_1', m.test_32u_good3_1, 0);
    returns('test_32u_good4_1', m.test_32u_good4_1, 0);
    returns('test_32u_good5_1', m.test_32u_good5_1, 0);
    returns('test_32s_good1_1', m.test_32s_good1_1, 0);
    returns('test_32s_good2_1', m.test_32s_good2_1, 0);
    returns('test_32s_good3_1', m.test_32s_good3_1, 0);
    returns('test_32s_good4_1', m.test_32s_good4_1, 0);
    returns('test_32s_good5_1', m.test_32s_good5_1, 0);
    returns('test_64_good1_1', m.test_64_good1_1, 0);
    returns('test_64_good2_1', m.test_64_good2_1, 0);
    returns('test_64_good3_1', m.test_64_good3_1, 0);
    returns('test_64_good4_1', m.test_64_good4_1, 0);
    returns('test_64_good5_1', m.test_64_good5_1, 0);
    ...
    returns('test_32u_good1_2', m.test_32u_good1_2, 0);
    returns('test_32u_good2_2', m.test_32u_good2_2, 0);
    returns('test_32u_good3_2', m.test_32u_good3_2, 0);
    returns('test_32u_good4_2', m.test_32u_good4_2, 0);
    returns('test_32u_good5_2', m.test_32u_good5_2, 0);
    returns('test_32s_good1_2', m.test_32s_good1_2, 0);
    returns('test_32s_good2_2', m.test_32s_good2_2, 0);
    returns('test_32s_good3_2', m.test_32s_good3_2, 0);
    returns('test_32s_good4_2', m.test_32s_good4_2, 0);
    returns('test_32s_good5_2', m.test_32s_good5_2, 0);
    returns('test_64_good1_2', m.test_64_good1_2, 0);
    returns('test_64_good2_2', m.test_64_good2_2, 0);
    returns('test_64_good3_2', m.test_64_good3_2, 0);
    returns('test_64_good4_2', m.test_64_good4_2, 0);
    ...
    traps(
        'test_32u_good3_3', m.test_32u_good3_3, "out of bounds memory access");
    traps(
        'test_32s_good3_3', m.test_32s_good3_3, "out of bounds memory access");
    ...
    traps('test_32u_bad_0', m.test_32u_bad_0, "out of bounds memory access");
    traps('test_32s_bad_0', m.test_32s_bad_0, "out of bounds memory access");
    ...
    traps('test_32u_bad_1', m.test_32u_bad_1, "out of bounds memory access");
    traps('test_32s_bad_1', m.test_32s_bad_1, "out of bounds memory access");
