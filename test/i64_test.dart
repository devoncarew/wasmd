...
void main() {
  group('i64', () {
    ...
    returns('test_extend32_s_0', g.expect_extend32_s_0, m.test_extend32_s_0);
    returns('test_extend32_s_1', g.expect_extend32_s_1, m.test_extend32_s_1);
    returns('test_extend32_s_2', g.expect_extend32_s_2, m.test_extend32_s_2);
    returns('test_extend32_s_3', g.expect_extend32_s_3, m.test_extend32_s_3);
    returns('test_extend32_s_4', g.expect_extend32_s_4, m.test_extend32_s_4);
    returns('test_extend32_s_5', g.expect_extend32_s_5, m.test_extend32_s_5);
    returns('test_extend32_s_6', g.expect_extend32_s_6, m.test_extend32_s_6);
    returns('test_extend32_s_7', g.expect_extend32_s_7, m.test_extend32_s_7);
    returns('test_extend32_s_8', g.expect_extend32_s_8, m.test_extend32_s_8);
    returns('test_extend32_s_9', g.expect_extend32_s_9, m.test_extend32_s_9);
