...
void main() {
  group('memory_3', () {
    ...
    returns('test_data_0', m.test_data_0, 1);
    returns('test_cast_0', m.test_cast_0, 42.0);
    returns('test_i32_load8_s_0', m.test_i32_load8_s_0, -1);
    returns('test_i32_load8_u_0', m.test_i32_load8_u_0, 255);
    returns('test_i32_load16_s_0', m.test_i32_load16_s_0, -1);
    returns('test_i32_load16_u_0', m.test_i32_load16_u_0, 0xffff);
    returns('test_i32_load8_s_1', m.test_i32_load8_s_1, 100);
    returns('test_i32_load8_u_1', m.test_i32_load8_u_1, 200);
    returns('test_i32_load16_s_1', m.test_i32_load16_s_1, 0x4e20);
    returns('test_i32_load16_u_1', m.test_i32_load16_u_1, 0x9c40);
    returns('test_i32_load8_s_2', m.test_i32_load8_s_2, 67);
    returns('test_i32_load8_s_3', m.test_i32_load8_s_3, -17);
    returns('test_i32_load8_u_2', m.test_i32_load8_u_2, 67);
    returns('test_i32_load8_u_3', m.test_i32_load8_u_3, 239);
    returns('test_i32_load16_s_2', m.test_i32_load16_s_2, 0x6543);
    returns('test_i32_load16_s_3', m.test_i32_load16_s_3, -0x3211);
    returns('test_i32_load16_u_2', m.test_i32_load16_u_2, 0x6543);
    returns('test_i32_load16_u_3', m.test_i32_load16_u_3, 0xcdef);
    returns('test_i64_load8_s_0', m.test_i64_load8_s_0, -1);
    returns('test_i64_load8_u_0', m.test_i64_load8_u_0, 255);
    returns('test_i64_load16_s_0', m.test_i64_load16_s_0, -1);
    returns('test_i64_load16_u_0', m.test_i64_load16_u_0, 0xffff);
    returns('test_i64_load32_s_0', m.test_i64_load32_s_0, -1);
    returns('test_i64_load32_u_0', m.test_i64_load32_u_0, 0xffffffff);
    returns('test_i64_load8_s_1', m.test_i64_load8_s_1, 100);
    returns('test_i64_load8_u_1', m.test_i64_load8_u_1, 200);
    returns('test_i64_load16_s_1', m.test_i64_load16_s_1, 0x4e20);
    returns('test_i64_load16_u_1', m.test_i64_load16_u_1, 0x9c40);
    returns('test_i64_load32_s_1', m.test_i64_load32_s_1, 0x4e20);
    returns('test_i64_load32_u_1', m.test_i64_load32_u_1, 0x9c40);
    returns('test_i64_load8_s_2', m.test_i64_load8_s_2, 67);
    returns('test_i64_load8_s_3', m.test_i64_load8_s_3, -17);
    returns('test_i64_load8_u_2', m.test_i64_load8_u_2, 67);
    returns('test_i64_load8_u_3', m.test_i64_load8_u_3, 239);
    returns('test_i64_load16_s_2', m.test_i64_load16_s_2, 0x6543);
    returns('test_i64_load16_s_3', m.test_i64_load16_s_3, -0x3211);
    returns('test_i64_load16_u_2', m.test_i64_load16_u_2, 0x6543);
    returns('test_i64_load16_u_3', m.test_i64_load16_u_3, 0xcdef);
    returns('test_i64_load32_s_2', m.test_i64_load32_s_2, 0x56346543);
    returns('test_i64_load32_s_3', m.test_i64_load32_s_3, -0x67453211);
    returns('test_i64_load32_u_2', m.test_i64_load32_u_2, 0x56346543);
    returns('test_i64_load32_u_3', m.test_i64_load32_u_3, 0x98bacdef);
  });
}
