...
void main() {
  group('endianness', () {
    ...
    returns(
      'i32_load_0',
      () => m0.i32_load($i32('FFFFFFFF')),
      $i32('FFFFFFFF'),
    );
    returns(
      'i32_load_1',
      () => m0.i32_load($i32('FD78A84E')),
      $i32('FD78A84E'),
    );
    returns('i32_load_2', () => m0.i32_load($i32('28757B2')), $i32('28757B2'));
    returns(
      'i32_load_3',
      () => m0.i32_load($i32('ABAD1DEA')),
      $i32('ABAD1DEA'),
    );
    returns(
      'i64_load16_s_0',
    ...
    returns(
      'f32_load_0',
      () => m0.f32_load($f32('BF800000')),
      $f32('BF800000'),
    );
    returns(
      'f32_load_1',
      () => m0.f32_load($f32('3C4A2DB6')),
      $f32('3C4A2DB6'),
    );
    returns(
      'f32_load_2',
      () => m0.f32_load($f32('45849365')),
      $f32('45849365'),
    );
    returns(
      'f32_load_3',
      () => m0.f32_load($f32('7F7FFFFF')),
      $f32('7F7FFFFF'),
    );
    returns(
      'f64_load_0',
