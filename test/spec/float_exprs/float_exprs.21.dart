...
class FloatExprs21Module extends Module {
  FloatExprs21Module() {
    vm = VM(this);
  }
  ...
  f32 f32_no_reassociate_add(f32 arg0, f32 arg1, f32 arg2, f32 arg3) => _func0(arg0, arg1, arg2, arg3);
  f64 f64_no_reassociate_add(f64 arg0, f64 arg1, f64 arg2, f64 arg3) => _func1(arg0, arg1, arg2, arg3);

  f32 _func0(f32 x, f32 y, f32 z, f32 w) {
    var t0 = vm.f32_add(x, y);
    var t1 = vm.f32_add(t0, z);
    var t2 = vm.f32_add(t1, w);
    return t2;
  }
