...
class FloatExprs30Module extends Module {
  FloatExprs30Module() {
    vm = VM(this);
  }
  ...
  f32 f32_no_fold_add_sub(f32 arg0, f32 arg1) => _func0(arg0, arg1);
  f64 f64_no_fold_add_sub(f64 arg0, f64 arg1) => _func1(arg0, arg1);

  f32 _func0(f32 x, f32 y) {
    var t0 = vm.f32_add(x, y);
    var t1 = vm.f32_sub(t0, y);
    return t1;
  }

  f64 _func1(f64 x, f64 y) {
    var t0 = vm.f64_add(x, y);
    var t1 = vm.f64_sub(t0, y);
    return t1;
  }
}
