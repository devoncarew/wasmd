...
class FloatExprs32Module extends Module {
  FloatExprs32Module() {
    vm = VM(this);
  }
  ...
  f32 f32_no_fold_mul_div(f32 arg0, f32 arg1) => _func0(arg0, arg1);
  f64 f64_no_fold_mul_div(f64 arg0, f64 arg1) => _func1(arg0, arg1);

  f32 _func0(f32 x, f32 y) {
    var t0 = vm.f32_mul(x, y);
    var t1 = vm.f32_div(t0, y);
    return t1;
  }

  f64 _func1(f64 x, f64 y) {
    var t0 = vm.f64_mul(x, y);
    var t1 = vm.f64_div(t0, y);
    return t1;
  }
}
