...
void main() {
  group('float_misc', () {
    ...
    returns('f32_sqrt_0', () => m0.f32_sqrt(f32('432B0000')), f32('41513A26'));
    returns('f32_sqrt_1', () => m0.f32_sqrt(f32('342CA6FE')), f32('39D23C4E'));
    returns(
      'f64_sqrt_0',
    ...
    returns('f32_sqrt_2', () => m0.f32_sqrt(f32('3E04C032')), f32('3EB85918'));
    returns('f32_sqrt_3', () => m0.f32_sqrt(f32('71ECDF78')), f32('58AE2029'));
    returns('f32_sqrt_4', () => m0.f32_sqrt(f32('3DA15ADB')), f32('3E8FB687'));
    returns('f32_sqrt_5', () => m0.f32_sqrt(f32('1C1B4268')), f32('2DC75D71'));
    returns('f32_sqrt_6', () => m0.f32_sqrt(f32('3A6C5E27')), f32('3CF5FCF5'));
    returns(
      'f64_sqrt_8',
    ...
    returns('f32_sqrt_7', () => m0.f32_sqrt(f32('4D135317')), f32('46423428'));
    returns('f32_sqrt_8', () => m0.f32_sqrt(f32('70B3001')), f32('233CC3B1'));
    returns('f32_sqrt_9', () => m0.f32_sqrt(f32('381EFDA8')), f32('3BC9BF1C'));
    returns('f32_sqrt_10', () => m0.f32_sqrt(f32('3987596')), f32('218BB203'));
    returns('f32_sqrt_11', () => m0.f32_sqrt(f32('265B82E')), f32('20F28105'));
    returns(
      'f64_sqrt_13',
    ...
    returns('f32_sqrt_12', () => m0.f32_sqrt(f32('7AB2BC3E')), f32('5D174152'));
    returns('f32_sqrt_13', () => m0.f32_sqrt(f32('4739B022')), f32('435A0720'));
    returns('f32_sqrt_14', () => m0.f32_sqrt(f32('3F500768')), f32('3F66C576'));
    returns('f32_sqrt_15', () => m0.f32_sqrt(f32('143D2640')), f32('29DC0CF2'));
    returns('f32_sqrt_16', () => m0.f32_sqrt(f32('10AE926A')), f32('28157BAF'));
    returns(
      'f64_sqrt_18',
    ...
    returns('f32_sqrt_17', () => m0.f32_sqrt(f32('3F800001')), f32('3F800000'));
    returns('f32_sqrt_18', () => m0.f32_sqrt(f32('3F800002')), f32('3F800001'));
    returns(
      'f64_sqrt_28',
    ...
    returns('f32_sqrt_19', () => m0.f32_sqrt(f32('3F7FFFFE')), f32('3F7FFFFF'));
    returns('f32_sqrt_20', () => m0.f32_sqrt(f32('3F7FFFFD')), f32('3F7FFFFE'));
    returns(
      'f64_sqrt_30',
    ...
    returns('f32_ceil_0', () => m0.f32_ceil(f32('3F7FFFFF')), f32('3F800000'));
    returns('f32_ceil_1', () => m0.f32_ceil(f32('3F800001')), f32('40000000'));
    returns(
      'f64_ceil_0',
    ...
    returns('f32_ceil_2', () => m0.f32_ceil(f32('4AFFFFFF')), f32('4B000000'));
    returns('f32_ceil_3', () => m0.f32_ceil(f32('CAFFFFFF')), f32('CAFFFFFE'));
    returns(
      'f64_ceil_2',
    ...
    returns('f32_ceil_4', () => m0.f32_ceil(f32('4B7FFFFF')), f32('4B7FFFFF'));
    returns('f32_ceil_5', () => m0.f32_ceil(f32('CB7FFFFF')), f32('CB7FFFFF'));
    returns(
      'f64_ceil_4',
