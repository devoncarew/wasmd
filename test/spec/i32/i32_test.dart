...
void main() {
  group('i32', () {
    ...
    returns('div_s_9', () => m0.div_s(i32('80000001'), 0x3E8), i32('FFDF3B65'));
    returns('div_s_10', () => m0.div_s(0x5, 0x2), 0x2);
    returns('div_s_11', () => m0.div_s(i32('FFFFFFFB'), 0x2), i32('FFFFFFFE'));
    returns('div_s_12', () => m0.div_s(0x5, i32('FFFFFFFE')), i32('FFFFFFFE'));
    returns('div_s_13', () => m0.div_s(i32('FFFFFFFB'), i32('FFFFFFFE')), 0x2);
    returns('div_s_14', () => m0.div_s(0x7, 0x3), 0x2);
    returns('div_s_15', () => m0.div_s(i32('FFFFFFF9'), 0x3), i32('FFFFFFFE'));
    returns('div_s_16', () => m0.div_s(0x7, i32('FFFFFFFD')), i32('FFFFFFFE'));
    returns('div_s_17', () => m0.div_s(i32('FFFFFFF9'), i32('FFFFFFFD')), 0x2);
    ...
    returns('div_u_10', () => m0.div_u(i32('FFFFFFFB'), 0x2), i32('7FFFFFFD'));
    ...
    returns('rem_s_9', () => m0.rem_s(i32('80000001'), 0x3E8), i32('FFFFFD79'));
    returns('rem_s_10', () => m0.rem_s(0x5, 0x2), 0x1);
    returns('rem_s_11', () => m0.rem_s(i32('FFFFFFFB'), 0x2), i32('FFFFFFFF'));
    ...
    returns('rem_s_15', () => m0.rem_s(i32('FFFFFFF9'), 0x3), i32('FFFFFFFF'));
    ...
    returns('shr_s_11', () => m0.shr_s(i32('80000000'), 0x1F), i32('FFFFFFFF'));
    returns('shr_s_12', () => m0.shr_s(i32('FFFFFFFF'), 0x20), i32('FFFFFFFF'));
    returns('shr_s_13', () => m0.shr_s(i32('FFFFFFFF'), 0x21), i32('FFFFFFFF'));
    returns(
      'shr_s_14',
    ...
    returns('shr_u_12', () => m0.shr_u(i32('FFFFFFFF'), 0x20), i32('FFFFFFFF'));
    returns('shr_u_13', () => m0.shr_u(i32('FFFFFFFF'), 0x21), i32('7FFFFFFF'));
    returns('shr_u_14', () => m0.shr_u(i32('FFFFFFFF'), i32('FFFFFFFF')), 0x1);
    returns('shr_u_15', () => m0.shr_u(i32('FFFFFFFF'), i32('7FFFFFFF')), 0x1);
    returns(
      'shr_u_16',
    ...
    returns('rotl_8', () => m0.rotl(i32('B0C1D2E3'), 0xFF05), i32('183A5C76'));
    returns(
      'rotl_9',
    ...
    returns('rotr_8', () => m0.rotr(i32('B0C1D2E3'), 0xFF05), i32('1D860E97'));
    returns(
      'rotr_9',
