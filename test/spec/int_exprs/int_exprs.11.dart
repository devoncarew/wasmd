// Generated from test/spec/int_exprs/int_exprs.11.wasm.
...
class IntExprs11Module extends Module {
  IntExprs11Module() {
    vm = VM(this);
  }
  ...
  i32 _func0(i32 x) {
    var t0 = vm.i32_div_s(x, 0);
    return t0;
  }

  i32 _func1(i32 x) {
    var t0 = vm.i32_div_u(x, 0);
    return t0;
  }

  i64 _func2(i64 x) {
    var t0 = vm.i64_div_s(x, 0);
    return t0;
  }

  i64 _func3(i64 x) {
    var t0 = vm.i64_div_u(x, 0);
    return t0;
  }
}
