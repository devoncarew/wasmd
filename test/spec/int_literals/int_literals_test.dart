...
void main() {
  group('int_literals', () {
    ...
    returns('i64_neg_smax_0', () => m0.i64_neg_smax(), i64('8000000000000001'));
    returns('i64_smin_0', () => m0.i64_smin(), i64('8000000000000000'));
    returns('i64_alt_smin_0', () => m0.i64_alt_smin(), i64('8000000000000000'));
    returns('i64_inc_smin_0', () => m0.i64_inc_smin(), i64('8000000000000001'));
