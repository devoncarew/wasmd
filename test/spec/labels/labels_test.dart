...
void main() {
  group('labels', () {
    ...
    returns('if_0', () => m0.$if(), 0x5);
    returns('if2_0', () => m0.if2(), 0x5);
    returns('switch_0', () => m0.$switch(0), 0x32);
    returns('switch_1', () => m0.$switch(0x1), 0x14);
    returns('switch_2', () => m0.$switch(0x2), 0x14);
    returns('switch_3', () => m0.$switch(0x3), 0x3);
    returns('switch_4', () => m0.$switch(0x4), 0x32);
    returns('switch_5', () => m0.$switch(0x5), 0x32);
    returns('return_0', () => m0.$return(0), 0);
    returns('return_1', () => m0.$return(0x1), 0x2);
    returns('return_2', () => m0.$return(0x2), 0x2);
