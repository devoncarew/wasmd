...
class MemoryInit3Module extends Module {
  MemoryInit3Module() {
  ...
  void _func0() {
    vm.memory_init(1, 0, 7, 0, 4);
    vm.data_drop(1);
    vm.memory_init(3, 0, 15, 1, 3);
    vm.data_drop(3);
    vm.memory_copy(0, 0, 20, 15, 5);
    vm.memory_copy(0, 0, 21, 29, 1);
    vm.memory_copy(0, 0, 24, 10, 1);
    vm.memory_copy(0, 0, 13, 11, 4);
    vm.memory_copy(0, 0, 19, 20, 5);
  }
