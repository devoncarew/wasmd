...
void main() {
  group('memory_trap', () {
    ...
    traps('store_1', () => m0.store(i32('FFFFFFFD'), i32('12345678')), _oobma);
    ...
    traps('f32_store_4', () => m1.f32_store(i32('FFFFFFFF'), f32('0')), _oobma);
    traps('f32_store_5', () => m1.f32_store(i32('FFFFFFFE'), f32('0')), _oobma);
    traps('f32_store_6', () => m1.f32_store(i32('FFFFFFFD'), f32('0')), _oobma);
    traps('f32_store_7', () => m1.f32_store(i32('FFFFFFFC'), f32('0')), _oobma);
    ...
    traps('f64_store_8', () => m1.f64_store(i32('FFFFFFFF'), f64('0')), _oobma);
    traps('f64_store_9', () => m1.f64_store(i32('FFFFFFFE'), f64('0')), _oobma);
    traps(
      'f64_store_10',
