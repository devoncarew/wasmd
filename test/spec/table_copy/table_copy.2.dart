// Generated from test/spec/table_copy/table_copy.2.wasm.
...
class TableCopy2Module implements Module {
  TableCopy2Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
