// Generated from test/spec/table_copy/table_copy.3.wasm.
...
class TableCopy3Module implements Module {
  TableCopy3Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
