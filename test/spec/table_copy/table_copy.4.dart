// Generated from test/spec/table_copy/table_copy.4.wasm.
...
class TableCopy4Module implements Module {
  TableCopy4Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
