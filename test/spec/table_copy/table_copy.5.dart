// Generated from test/spec/table_copy/table_copy.5.wasm.
...
class TableCopy5Module implements Module {
  TableCopy5Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
