// Generated from test/spec/table_copy/table_copy.8.wasm.
...
class TableCopy8Module implements Module {
  TableCopy8Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
