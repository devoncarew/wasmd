// Generated from test/spec/table_copy/table_copy.9.wasm.
...
class TableCopy9Module implements Module {
  TableCopy9Module({required this.aImports}) {
    segments.init();
    vm = VM(this);
  }
