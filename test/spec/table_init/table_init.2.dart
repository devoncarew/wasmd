// Generated from test/spec/table_init/table_init.2.wasm.
...
class TableInit2Module extends Module {
  TableInit2Module({required this.aImports}) {
  ...
  void _func5() {
    ...
    frame.i32_const(3);
    {
      ...
      elementSegments.copyTo(table0, sourceOffset, destOffset, count, elementSegments.segment3);
    }
  }
