// Generated from test/spec/table_init/table_init.5.wasm.
...
class TableInit5Module extends Module {
  TableInit5Module({required this.aImports}) {
  ...
  void _func5() {
    ...
    frame.i32_const(3);
    {
      ...
      elementSegments.copyTo(table1, sourceOffset, destOffset, count, elementSegments.segment3);
    }
  }
